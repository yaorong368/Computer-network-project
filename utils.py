...
class My_dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        user_id = self.user_remain[index_user]
        ...
        if (index % 2) == 0:
            return user_tensor, event_matrix_train, train_target
        else:
            return user_tensor, event_matrix_test, test_target
